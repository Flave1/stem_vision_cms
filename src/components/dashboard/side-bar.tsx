...
function CustomToggle({ children, eventKey, onClick }:any) {
    ...
    const decoratedOnClick = useAccordionButton(eventKey, (active:any) => onClick({state: !active, eventKey: eventKey}));
                  ...
                  setLocationsCollapse(!locationsCollapse)
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            ...
                            <i className="icon">
                                    ...
                                    <span className="item-name mx-2">Country</span>
                                </Link>
                            </span>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            ...
                            <Link className={`${location.pathname === dashboard_routes.locationLocations.state ? 'active' : ''} nav-link px-4 `} aria-current="page" to={dashboard_routes.locationLocations.state} onClick={() => {}}>
                            <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name mx-2">State</span>
                                </Link>
                            </div>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            <div className="nav-item">
                            <Link className={`${location.pathname === dashboard_routes.locationLocations.city ? 'active' : ''} nav-link px-4 `} aria-current="page" to={dashboard_routes.locationLocations.city} onClick={() => {}}>
                            <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name mx-2">City</span>
                                </Link>
                            </div>
