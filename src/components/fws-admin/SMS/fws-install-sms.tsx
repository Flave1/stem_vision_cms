...
const CreateSms = (props: any) => {
  ...
  const [schoolURlPreview, setPreview] = useState('http://flaveconsole.com')
  //VALIDATIONS SCHEMA
...
function mapDispatchToProps(dispatch: any) {
  return {
    ...
    addSms: (values: any, navigate: any) => AddSms(values, navigate)(dispatch)
  };
}
