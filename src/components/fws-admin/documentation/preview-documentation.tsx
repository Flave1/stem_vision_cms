            ...
            <Card.Header className="d-flex justify-content-between">
              <div className="header-title">
                <h4 className="card-title m-3 ">
                  <b>{singleDocumentation?.subject}</b>
                </h4>
              </div>
            </Card.Header>  
...
function mapDispatchToProps(dispatch: any) {
    return { getSingleDoc: (id: any, pageNumber: number) => GetSingleDoc(id)(dispatch) };
}

export default connect(mapStateToProps, mapDispatchToProps)(PreviewDocumentation)